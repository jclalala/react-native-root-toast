...
let styles = StyleSheet.create({
    ...
    defaultIconStyle: {width: 24, height: 24, marginBottom: 8, alignSelf: 'center'}
});
...
class ToastContainer extends Component {
    ...
    render() {
        ...
        let warningIcon = <Image
        source={require('./images/ic_warning.png')}
        style={[styles.defaultIconStyle, this.props.iconStyle]}
        resizeMode={"contain"}
        />;
    ...
    >
        {this.props.showWarningIcon ? warningIcon : null}
    <Text style={[
                styles.textStyle,
            props.textStyle,
